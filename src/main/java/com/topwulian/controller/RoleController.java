...
import com.topwulian.dao.RoleDao;
...
import com.topwulian.service.RoleService;
...
public class RoleController {
	...
	public List<Role> roles() {
	    //如果是admin就返回全部，否则将admin去掉
        List<Role> roleList = roleDao.list(Maps.newHashMap(), null, null);
