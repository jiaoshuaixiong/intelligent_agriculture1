...
import com.topwulian.filter.LogoutFilter;
import com.topwulian.filter.RestfulFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/MP_verify_kIMZz3A0TlLmMaIe.txt", "anon");
		filterChainDefinitionMap.put("/tasklist/**", "anon");
		filterChainDefinitionMap.put("/home.html", "anon");
        filterChainDefinitionMap.put("/mobielogin.html", "anon");
		filterChainDefinitionMap.put("/fonts/**", "anon");
		filterChainDefinitionMap.put("/wxlogin/login", "anon");
		filterChainDefinitionMap.put("/tTasks/producterIdList", "anon");
		filterChainDefinitionMap.put("/tTasks/producterIdCount", "anon");
		filterChainDefinitionMap.put("/tTasks/mobile", "anon");
		filterChainDefinitionMap.put("/tTasks/push", "anon");
		...
		filterChainDefinitionMap.put("/mobile_producter/**","anon");
